...
from student.ingestion import Ingestor
from student.BM25 import SearchEngine
from student.models import RagDataset, StudentSearchResults
from student.models import MinimalSearchResults
from student.models import StudentSearchResultsAndAnswer, MinimalAnswer
from student.utils import calculate_overlap

DATA_PATH_DEFAULT = "data/raw/vllm-0.10.1"
INDEX_PATH_DEFAULT = "data/processed/bm25_index"
CHUNKS_PATH_DEFAULT = "data/processed/chunks"
...
class RagCLI:
    ...
    def index(self,
              ...
              chunks_path: str = CHUNKS_PATH_DEFAULT) -> None:
        """
        ...
        try:
            ...
            with open(chunks_file, "w", encoding="utf-8") as f:
                for source, text in zip(all_sources, all_texts):
                    record = {
    ...
    def answer(self,
        ...
        if avg_score < 3 or dominance_ratio > 1.5:
